...
if(isset($_POST['login'])) {
    ...
    if ($total > 0) {
        ...
        if($password == $db_password) {
            ...
            echo header("Location: home.php?Access=".base64_encode($Access));    
...
if(isset($_POST['register'])) {
    ...
    if(isEmailValid($_POST['email']) == 1) {
        ...
        $loginErrorMsg="Email Input Validation Error";
    ...
    if(isPasswordValid($_POST['password']) == 1) {
        ...
        $loginErrorMsg="Password Input Validation Error";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-6 home-left">
                    <h1 class="brand-title text-center text-white"> <b><br><br><br>A W A S<br><br>B L O G</b></h1>  
            </div>
